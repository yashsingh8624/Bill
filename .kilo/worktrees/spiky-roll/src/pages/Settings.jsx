          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-start">
               <div className="w-full sm:w-1/3 flex flex-col items-center gap-3">
                  <div className="w-32 h-32 rounded-xl border-2 border-dashed border-slate-300 bg-slate-50 flex items-center justify-center overflow-hidden relative group">
                     {formData.logo ? (
                        <>
                  ...
                  <p className="text-[10px] text-slate-500 text-center font-medium max-w-[150px]">For best results, upload a square PNG/JPG under 500KB.</p>
               </div>
               
               <div className="w-full sm:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-5">
