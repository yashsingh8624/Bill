    ...
    <div className="max-w-6xl mx-auto space-y-6 pb-12 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-shadow">
           ...
           <h3 className="text-3xl font-black text-slate-800">Γé╣{stats.totalSales.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</h3>
        ...
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-shadow">
           ...
           <h3 className="text-3xl font-black text-slate-800">Γé╣{stats.totalPaid.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</h3>
                 ...
                 {filteredBills.map((bill, idx) => (
                   <tr key={idx} className="hover:bg-slate-50/80 transition-all duration-300 group">
                      ...
                      <td className="py-5 px-6 text-right">
                         <p className="font-black text-slate-800 text-sm">Γé╣{bill.amountPaid.toFixed(2)}</p>
